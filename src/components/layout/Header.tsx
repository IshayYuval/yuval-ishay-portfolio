            ...
            >
                <div className="w-full nav-bar-container gap-4 h-[var(--header-height)] flex items-center justify-between relative z-50">
                    ...
                    <div className="hidden md:flex gap-4 items-center">
                        <a href="https://www.instagram.com/yuvalishay.art" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity" style={{ color: dynamicTextColor || 'var(--foreground)' }}>
                            <svg
                                className="w-6 h-6 transition-colors duration-300"
                                viewBox="0 0 30 24"
                                fill="currentColor"
                                style={!dynamicTextColor ? { filter: 'invert(1)' } : {}} // Invert for default dark background (white icon), remove filter for specific color
                            >
                                <g>
                        ...
                        <a href="https://www.linkedin.com/in/yuvalishay-art" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity" style={{ color: dynamicTextColor || 'var(--foreground)' }}>
                            <svg
                                className="w-6 h-6 transition-colors duration-300"
                                viewBox="0 0 30 24"
                                fill="currentColor"
                                style={!dynamicTextColor ? { filter: 'invert(1)' } : {}}
                            >
