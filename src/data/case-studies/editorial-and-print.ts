...
export const editorialAndPrintCaseStudies: CaseStudy[] = [
    ...
    processSteps: [
      {
        ...
        textAfter:
          "I'm happy to say my catalogue was one of the few selected for the annual Artist Catalog Exhibition, held at Beit Ariela in collaboration with HIT.",
      },
    ],
    gallery: [
      {
  ...
  // typography - liebling haus
  {
    ...
    excerpt:
      "An infographic poster, based on the architectual style of Liebling Haus.",
    tags: [
      "HIT",
      "Visual Communication BA",
      "2nd Year",
  ...
  // typography - dance tel aviv
  {
    ...
    excerpt:
      "A typographic flyer, capturing the movement and soul of the festival",
    tags: [
      "HIT",
      "Visual Communication BA",
      "2nd Year",
  ...
  // typography - ezer alchemist homage
  {
    ...
    excerpt:
      "A typographic tribute to Ezer Alchemist, using its ink traps as a visual tool to teach and reveal the character of the typeface.",
