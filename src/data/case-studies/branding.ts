...
export const brandingCaseStudies: CaseStudy[] = [
  // branding - cheetah
  {
    slug: "cheetah",
    title: "Cheetah",
    ...
    processSteps: [
      {
        ...
        textAfter:
          "The concept will be the source of the tone of the brand, as well as the looks, the feel and the entire visual identity, including the logo, the colors, the typography and the applications of the brand.",
      },
    ],
    contentSections: [
      {
